CREATE OR REPLACE FUNCTION public.sp_crud_automatico_agremiado_cuota_fecha_individual(p_anio character varying, p_id_agremiado character varying)
...
begin
	...
	loop
		...
		loop
			...
			from conceptos c where codigo='00006' and periodo=(p_anio::int-1)::varchar;
