            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:10px">
                ...
                <div class="card-body">				
                    ...
                    <table id="tblPuesto" class="table table-hover table-sm">
                        ...
                        ?>
                        <tr>
                            <td class="text-left" style="vertical-align:middle"><?php echo $row->ruta ?></td>
                            
                            <td class="text-left" style="vertical-align:middle">
                                <a href="/<?php echo $row->ruta_informe ?>" target="_blank" class="btn btn-sm btn-secondary">Ver Informe</a>
                            </td>
                        </tr>
						<?php 
							}	
