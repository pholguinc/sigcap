...
<ol class="breadcrumb" style="padding-left:130px;margin-top:0px;background-color:#283659">
        <li class="breadcrumb-item text-primary">Inicio</li>
            <li class="breadcrumb-item active">Consulta de Centro de Costo</li>
        </li>
    </ol>
@endsection
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0 text-primary">
                        Consultar Centro de Costo <!--<small class="text-muted">Usuarios activos</small>-->
                    </h4>
                </div><!--col-->
            </div>
        ...
        <div class="col col-sm-12 align-self-center">
            ...
            <div class="card">
				...
				<div class="row" style="padding:20px 20px 0px 20px;">
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-12 col-xs-12">
						<input class="form-control form-control-sm" id="codigo" name="codigo" placeholder="C&oacute;digo">
					</div>
...
<script src="{{ asset('js/centro_costo/lista.js') }}"></script>
