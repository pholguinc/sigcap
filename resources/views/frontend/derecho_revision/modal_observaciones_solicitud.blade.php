...
$(document).ready(function() {
	...
	datatableObservacion()

});

function datatableObservacion(){
	
	var id =  $('#id').val();
	
    $("#tblObservacion tbody").html("");
	$.ajax({
			url: "/derecho_revision/obtener_observaciones/"+id,
			type: "GET",
			success: function (result) {  
					$("#tblObservacion tbody").html(result);
			}
	});
}
		...
		<div class="card">
			...
			<div class="card-body">
				<div class="table-responsive">
					<table id="tblObservacion" class="table table-hover table-sm">
						<thead>
