            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0 text-primary">
                        Consulta de personas <!--<small class="text-muted">Usuarios activos</small>-->
                    </h4>
                </div><!--col-->
            </div>
            ...
            <div class="card">
				...
				<div class="row" style="padding:20px 20px 0px 20px;">
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<input class="form-control form-control-sm" id="doc" name="doc" placeholder="N&uacute;mero Documento">
					</div>
                ...
                <div class="card-body">				
                    ...
                    <table id="tblPersona" class="table table-hover table-sm">
                        <thead>
...
<script src="{{ asset('js/pasona.js') }}"></script>
